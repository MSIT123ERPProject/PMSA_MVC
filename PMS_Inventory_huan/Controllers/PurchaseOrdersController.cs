...
namespace PMSAWebMVC.Controllers
{
    public class PurchaseOrdersController : Controller
    {
        ...
        {
            var data = Repository.GetPurchaseOrderDtlList(id, supplierCode);
        ...
        private void ConfigureViewModel(PurchaseOrderCreateViewModel model)
        {
            ...
            IList<PurchaseRequisitionItem> purchaseRequisitions = Repository.GetPurchaseRequisitionList();
            ...
            {
                IEnumerable<SupplierItem> suppliers = Repository.GetSupplierList(model.SelectedPurchaseRequisitionID);
