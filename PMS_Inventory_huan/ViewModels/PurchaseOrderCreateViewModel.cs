...
using PMSAWebMVC.ViewModels.PurchaseOrderCreate;
using System;
...
namespace PMSAWebMVC.ViewModels.PurchaseOrderCreate
{
    ...
    public class Repository
    {
        public static Employee GetEmployee()
        {
            ...
            {
                return db.Employee.Find("CE00002");
            }
        }
        ...
        public static IList<SupplierItem> GetSupplierList(string purchaseRequisitionID)
        {
        ...
        public static IEnumerable<PurchaseOrderDtlItem> GetPurchaseOrderDtlList(string purchaseRequisitionID, string supplierCode)
        {
